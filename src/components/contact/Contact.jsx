    ...
    return (
        <section className="projects section" id="contact">
            ...
            <div className="contact_container container grid">
                <div className="contact_content">
                    ...
                    <div className="contact_info">
                        <div className="contact_card">
                            ...
                            <span className="contact_card-data">Ariel Fortalisa</span>

                            <a href="https://www.facebook.com/fortalisaariel/" className="contact_button">
                                Write me
                        ...
                        <div className="contact_card">
                            <i className="uil uil-github-alt contact_card-icon"></i>

                            <h3 className="contact_card-title">Github</h3>
                            <span className="contact_card-data">Ariel-Fortalisa</span>

                            <a href="https://github.com/Ariel-Fortalisa" className="contact_button">
                                Write me
                                <i className="uil uil-arrow-right contact_button-icon"></i>
                            </a>
                        </div>
                        ...
                        <div className="contact_card">
                            ...
                            <a href="https://www.linkedin.com/in/ariel-fortalisa-4a8b79318/" className="contact_button">
                                Write me
                                <i className="uil uil-arrow-right contact_button-icon"></i>
                            </a>
                        </div>
                ...
                <div className="contact_content">
                    <h3 className="contact_title">You can also send a <br />message via email.</h3>
