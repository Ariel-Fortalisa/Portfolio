...
const Data = () => {
  return (
    <div className="home_data">
        <h1 className="home_title">Ariel Fortalisa
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home_description">Developing dynamic websites that achieve results and adaptive design for a smooth user experience.</p>
